...
**
** Created: Sun Jan 28 18:25:24 2018
...
static const char qt_meta_stringdata_KeyDel[] = {
    ...
    "TouchButtonMsg(int)\0,,\0RockerSgl(int,int,int)\0"
    "OsdUpdate(int)\0"
};
...
int KeyDel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: RockerSgl((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
...
// SIGNAL 2
void KeyDel::RockerSgl(int _t1, int _t2, int _t3)
{

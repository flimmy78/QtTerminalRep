...
**
** Created: Thu Jan 25 03:07:06 2018
...
static const char qt_meta_stringdata_se_terminal[] = {
    ...
    "x,y,press\0TouchRockerDeal(int,int,int)\0"
    "OsdUpdateFunc(int)\0"
};
...
int se_terminal::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: TouchRockerDeal((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
